...
const ENV_VALIDATORS = {
  KODO_MODEL_PROVIDER: optional(optionalString),
  KODO_MODEL_API_KEY: optional(optionalString),
  KODO_MODEL_BASE_URL: optional(optionalString),
  KODO_MODEL_NAME: optional(optionalString),
  KODO_MODEL_REASONING_EFFORT: optional(optionalString),
  KODO_MODEL_MAX_OUTPUT_TOKENS: optional(optionalNumber),
  KODO_MODEL_CONTEXT_WINDOW: optional(optionalNumber),
...
const mapCommonBootstrapEnv = (raw: RawBootstrapEnv): BootstrapCommonOptions => ({
  ...
  provider: raw.KODO_MODEL_PROVIDER,
  apiKey: raw.KODO_MODEL_API_KEY,
  baseUrl: raw.KODO_MODEL_BASE_URL,
  model: raw.KODO_MODEL_NAME,
  reasoningEffort: raw.KODO_MODEL_REASONING_EFFORT,
  maxOutputTokens: raw.KODO_MODEL_MAX_OUTPUT_TOKENS,
  contextWindow: raw.KODO_MODEL_CONTEXT_WINDOW,
